...
; Line 122
	...
	sub	edx, DWORD PTR _channels[edi+8]
; Line 123
	cmp	ecx, edx
	jb	SHORT $L594
	mov	ecx, edx
...
$L530:
; Line 129
	cmp	DWORD PTR _GAME_SETTINGS+72, edx
	jb	SHORT $L531
; Line 130
...
CONST	SEGMENT
$T601	DQ	03fe8000000000000r		; 0.75
$T602	DQ	03fd0000000000000r		; 0.25
CONST	ENDS
;	COMDAT _mix_music
_TEXT	SEGMENT
_ptr$ = 8
