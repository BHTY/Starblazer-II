...
_DATA	SEGMENT
	ORG $+3
$SG591	DB	'CAMPAIGN', 00H
	ORG $+3
$SG592	DB	'MULTIPLAYER', 00H
$SG593	DB	'OPTIONS', 00H
_DATA	ENDS
_TEXT	SEGMENT
_id$ = -12
_buttonData$ = -4
...
; Line 46
	...
	mov	DWORD PTR [eax+12], OFFSET FLAT:$SG591
; Line 47
	mov	eax, DWORD PTR _buttonData$[ebp]
	mov	BYTE PTR [eax], 3
; Line 48
...
; Line 60
	mov	eax, DWORD PTR _buttonData2$[ebp]
	mov	DWORD PTR [eax+12], OFFSET FLAT:$SG592
; Line 61
	mov	eax, DWORD PTR _buttonData3$[ebp]
	mov	DWORD PTR [eax+12], OFFSET FLAT:$SG593
; Line 63
	mov	eax, DWORD PTR _buttonData$[ebp]
...
_DATA	SEGMENT
$SG609	DB	'STARBLAZER', 00H
	ORG $+1
$SG610	DB	'    II', 00H
	ORG $+1
$SG611	DB	'BY WILL KLEES AND JOSH PIETY', 00H
_DATA	ENDS
_TEXT	SEGMENT
_mouse$ = -8
