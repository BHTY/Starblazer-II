...
EXTRN	_malloc:NEAR
_DATA	SEGMENT
$SG720	DB	'CAMPAIGN', 00H
	ORG $+3
$SG721	DB	'MULTIPLAYER', 00H
$SG722	DB	'OPTIONS', 00H
_DATA	ENDS
_TEXT	SEGMENT
_id$ = -12
_buttonData$ = -4
...
; Line 63
	mov	edx, DWORD PTR _buttonData2$[ebp]
	mov	DWORD PTR [edx+12], OFFSET FLAT:$SG721
; Line 64
	mov	eax, DWORD PTR _buttonData3$[ebp]
	mov	DWORD PTR [eax+12], OFFSET FLAT:$SG722
; Line 66
	mov	ecx, DWORD PTR _buttonData$[ebp]
...
_DATA	SEGMENT
$SG725	DB	'assets/star.obj', 00H
$SG727	DB	'sfx/menu.wav', 00H
_DATA	ENDS
_TEXT	SEGMENT
...
_DATA	SEGMENT
	ORG $+3
$SG740	DB	'STARBLAZER', 00H
	ORG $+1
$SG741	DB	'    II', 00H
	ORG $+1
$SG742	DB	'BY WILL KLEES AND JOSH PIETY', 00H
_DATA	ENDS
_TEXT	SEGMENT
_mouse$ = -8
