...
CONST	SEGMENT
$T8556	DQ	04074000000000000r		; 320
$T8557	DQ	04069000000000000r		; 200
CONST	ENDS
;	COMDAT _WndProc@16
_TEXT	SEGMENT
; File src\star_win.c
...
; Line 128
	...
	mov	ecx, DWORD PTR _wParam$[esp+8]
...
; Line 93
	...
	fidiv	DWORD PTR -4+[esp+16]
	mov	eax, DWORD PTR _hwnd
	mov	DWORD PTR -4+[esp+16], edx
	push	eax
	fstp	DWORD PTR _mouseFactorX
; Line 94
	fld	QWORD PTR $T8557
	fidiv	DWORD PTR -4+[esp+20]
...
$L8407:
	...
	mov	eax, DWORD PTR $T8565[esp+404]
	mov	edi, eax
...
; Line 255
	call	_SG_GameInit
; Line 257
	lea	eax, DWORD PTR $T8581[esp+472]
	push	eax
