...
; Line 190
	...
	mov	ebx, DWORD PTR _COS_LUT_SMALL[eax]
	mov	ebp, DWORD PTR _SIN_LUT_SMALL[eax]
; Line 191
...
; Line 246
	...
	push	eax
	call	_fixed_mul
	mov	ebx, DWORD PTR _a$[esp+36]
	add	esp, 8
	sub	ebp, eax
	push	esi
	mov	DWORD PTR [ebx+12], ebp
; Line 247
	mov	eax, DWORD PTR _sc$[esp+36]
	push	eax
	call	_fixed_mul
	add	esp, 8
	mov	ebp, eax
