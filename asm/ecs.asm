...
$SG557	DB	'v', 00H
	ORG $+2
$SG558	DB	'%f %f %f', 0aH, 00H
	ORG $+2
$SG560	DB	'f', 00H
	ORG $+2
$SG561	DB	'%d %d %d', 0aH, 00H
	ORG $+2
$SG563	DB	'usemtl', 00H
	ORG $+1
$SG564	DB	'%d', 00H
